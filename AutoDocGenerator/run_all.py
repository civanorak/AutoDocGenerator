...
# ─── AŞAMA 4: HTML Generator ──────────────────────────────────────────────────
print("[Aşama 4/4]  HTML Generator baslatiliyor...\n")
t3 = time.time()
site_gen = load_script(os.path.join(base, "build_site.py"))
site_gen.build()
...
print(f"  Dokümantasyon (HTML): {os.path.join(base, 'site')}")
print("")
print("  Sıradaki adımlar:")
print("  1. 'site/index.html' dosyasini tarayicinizda acin")
print("  2. 'site' klasorunu zip haline getirip paylasin")
print("=" * 60)
